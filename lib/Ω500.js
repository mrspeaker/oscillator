...
(function (Ω) {
	...
	var Image = Ω.Class.extend({
		...
		renderClip: function (gfx, x, y, sx, sy, w, h) {
...
(function (Ω) {
	...
	Part.prototype = {
		...
		reset: function () {
			...
			this.ySpeed = Math.random() - 0.5 - 0.25 - 0.5;
		},
...
(function (Ω) {
	...
	var Shake = Ω.Class.extend({
		...
		render: function (gfx) {
			...
			gfx.ctx.translate(Math.random() * this.force | 0, Math.random() * this.force | 0);
